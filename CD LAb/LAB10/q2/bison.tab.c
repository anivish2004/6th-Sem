...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_stmt_body = 16                  /* stmt_body  */
};
...
static const char *const yytname[] =
{
  ...
  "NUMBER", "RELOP", "NL", "'('", "')'", "';'", "$accept", "stmt",
  "if_stmt", "condition", "stmt_body", YY_NULLPTR
};
...
{
       7,     8,    13,    14,    15,    16,     1,     4,     5,     6,
      12,    10,    11,    19,    17,    20,    21
};
...
{
       0,     3,    13,    14,     9,     0,     8,     5,     6,    15,
       7,     7,    10,     5,     6,     5,     6,     5,    16,    11,
       4,    16
};
